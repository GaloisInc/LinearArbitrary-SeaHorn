  ...
  modifies $M.0, alloc, $CurrAddr;
{
  var $b: bool;
$bb0:
  assume {:sourceloc "matrix_inv2.c", 1, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv2.c", 2, 0} true;
  $b := (cond != 0);
  assume {:sourceloc "matrix_inv2.c", 2, 0} true;
  goto $bb3, $bb4;
$bb1:
  assume {:sourceloc "matrix_inv2.c", 5, 0} true;
  return;
$bb2:
  assume {:sourceloc "matrix_inv2.c", 2, 0} true;
  goto $bb5;
...
$bb4:
  ...
  goto $bb2;
$bb5:
  assume {:sourceloc "matrix_inv2.c", 3, 0} true;
  goto $bb5;
}
  ...
  modifies $M.0, alloc, $CurrAddr;
{
  ...
  var $p30: int;
$bb0:
  assume {:sourceloc "matrix_inv2.c", 11, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv2.c", 12, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv2.c", 14, 0} true;
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv2.c", 16, 0} true;
  havoc $p3;
  assume {:sourceloc "matrix_inv2.c", 16, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv2.c", 17, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv2.c", 17, 0} true;
  $p4 := 0;
  ...
  goto $bb1;
$bb1:
  assert ($p5 >= $M.0[$p2] || $p4 == 0);
  assume {:sourceloc "matrix_inv2.c", 17, 0} true;
  $b := $ult($p4, 1);
  assume {:sourceloc "matrix_inv2.c", 17, 0} true;
  goto $bb4, $bb5;
$bb2:
  assume {:sourceloc "matrix_inv2.c", 19, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv2.c", 19, 0} true;
  $p12 := 0;
  ...
  goto $bb6;
$bb3:
  assume {:sourceloc "matrix_inv2.c", 28, 0} true;
  $p6 := $mul(0, 1);
  assume {:sourceloc "matrix_inv2.c", 28, 0} true;
  $p7 := $pa($p2, $p6, 4);
  assume {:sourceloc "matrix_inv2.c", 28, 0} true;
  ...
  assume {:sourceloc "matrix_inv2.c", 28, 0} true;
  assert $p11 == 1;
  assume {:sourceloc "matrix_inv2.c", 29, 0} true;
...
$bb6:
  ...
  goto $bb9, $bb10;
$bb7:
  assume {:sourceloc "matrix_inv2.c", 22, 0} true;
  havoc $p16;
  assume {:sourceloc "matrix_inv2.c", 22, 0} true;
  $p17 := $mul($p4, 1);
  assume {:sourceloc "matrix_inv2.c", 22, 0} true;
  ...
  assume {:sourceloc "matrix_inv2.c", 22, 0} true;
  $M.0[$p19] := $p16;
  assume {:sourceloc "matrix_inv2.c", 24, 0} true;
  $p20 := $mul($p4, 1);
  assume {:sourceloc "matrix_inv2.c", 24, 0} true;
  $p21 := $pa($p2, $p20, 4);
  assume {:sourceloc "matrix_inv2.c", 24, 0} true;
  ...
  goto $bb14, $bb15;
$bb8:
  assume {:sourceloc "matrix_inv2.c", 26, 0} true;
  goto $bb11;
$bb9:
  assume {:sourceloc "matrix_inv2.c", 19, 0} true;
  assume $b14;
...
$bb11:
  ...
  goto $bb1;
$bb12:
  assume {:sourceloc "matrix_inv2.c", 25, 0} true;
  $p27 := $mul($p4, 1);
  assume {:sourceloc "matrix_inv2.c", 25, 0} true;
  $p28 := $pa($p2, $p27, 4);
  assume {:sourceloc "matrix_inv2.c", 25, 0} true;
