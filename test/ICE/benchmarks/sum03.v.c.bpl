// SMACK-PRELUDE-BEGIN
function {:existential true} b0(x:int, sn:int, v1: int, v2: int, v3: int): bool;
...
axiom (__VERIFIER_nondet_uint == -3072);
  ...
  modifies alloc, $CurrAddr;
{
  var $b: bool;
$bb0:
  assume {:sourceloc "sum03_havoc.c", 1, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 2, 0} true;
  $b := (cond != 0);
  assume {:sourceloc "sum03_havoc.c", 2, 0} true;
  goto $bb3, $bb4;
$bb1:
  assume {:sourceloc "sum03_havoc.c", 5, 0} true;
  return;
$bb2:
  assume {:sourceloc "sum03_havoc.c", 2, 0} true;
  goto $bb5;
...
$bb4:
  ...
  goto $bb2;
$bb5:
  assume {:sourceloc "sum03_havoc.c", 3, 0} true;
  goto $bb5;
}
  ...
  modifies alloc, $CurrAddr;
{
  ...
  var $p12: int;
$bb0:
  assume {:sourceloc "sum03_havoc.c", 12, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 13, 0} true;
  call $p := __VERIFIER_nondet_uint();
  assume {:sourceloc "sum03_havoc.c", 13, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 13, 0} true;
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 14, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 17, 0} true;
  $p2 := 0;
  $p3 := 0;
  goto $bb1;
$bb1:
  assert b0($p3, $p2, $p10, $p11, $p12);

  assume {:sourceloc "sum03_havoc.c", 18, 0} true;
  $p4 := $add($p2, 1);
  assume {:sourceloc "sum03_havoc.c", 18, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 19, 0} true;
  $p5 := $add($p3, 1);
  assume {:sourceloc "sum03_havoc.c", 19, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 20, 0} true;
  $p6 := $mul($p5, 1);
  assume {:sourceloc "sum03_havoc.c", 20, 0} true;
  $b := ($p4 == $p6);
  assume {:sourceloc "sum03_havoc.c", 20, 0} true;
...
$bb2:
  ...
  assume {:sourceloc "sum03_havoc.c", 20, 0} true;
  assert $p9 == 1;
  assume {:sourceloc "sum03_havoc.c", 21, 0} true;
  havoc $p10;
  assume {:sourceloc "sum03_havoc.c", 21, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 22, 0} true;
  havoc $p11;
  assume {:sourceloc "sum03_havoc.c", 22, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 23, 0} true;
  havoc $p12;
  assume {:sourceloc "sum03_havoc.c", 23, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum03_havoc.c", 24, 0} true;
  $p2 := $p4;
  $p3 := $p5;
  goto $bb1;
$bb3:
