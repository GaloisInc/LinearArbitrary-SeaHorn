// SMACK-PRELUDE-BEGIN
function {:existential true} b0(i:int, n:int, sn:int, v1: int, v2: int, v3: int): bool;
  ...
  modifies alloc, $CurrAddr;
{
  var $b: bool;
$bb0:
  assume {:sourceloc "sum01_havoc.c", 1, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum01_havoc.c", 2, 0} true;
  $b := (cond != 0);
  assume {:sourceloc "sum01_havoc.c", 2, 0} true;
  goto $bb3, $bb4;
$bb1:
  assume {:sourceloc "sum01_havoc.c", 5, 0} true;
  return;
$bb2:
  assume {:sourceloc "sum01_havoc.c", 2, 0} true;
  goto $bb5;
...
$bb4:
  ...
  goto $bb2;
$bb5:
  assume {:sourceloc "sum01_havoc.c", 3, 0} true;
  goto $bb5;
}
  ...
  modifies alloc, $CurrAddr;
{
  ...
  var $p12: int;
$bb0:
  assume {:sourceloc "sum01_havoc.c", 11, 0} true;
  havoc $p;
  assume {:sourceloc "sum01_havoc.c", 11, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum01_havoc.c", 13, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum01_havoc.c", 13, 0} true;
  $p1 := 1;
...
$bb1:
  ...
  goto $bb4, $bb5;
$bb2:
  assume {:sourceloc "sum01_havoc.c", 14, 0} true;
  $p8 := $add($p2, 1);
  assume {:sourceloc "sum01_havoc.c", 14, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum01_havoc.c", 15, 0} true;
  havoc $p9;
  assume {:sourceloc "sum01_havoc.c", 15, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum01_havoc.c", 16, 0} true;
  havoc $p10;
  assume {:sourceloc "sum01_havoc.c", 16, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum01_havoc.c", 17, 0} true;
  havoc $p11;
  assume {:sourceloc "sum01_havoc.c", 17, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "sum01_havoc.c", 19, 0} true;
  goto $bb10;
$bb3:
  assume {:sourceloc "sum01_havoc.c", 20, 0} true;
  $p3 := $mul($p, 1);
  assume {:sourceloc "sum01_havoc.c", 20, 0} true;
  $b4 := ($p2 == $p3);
  assume {:sourceloc "sum01_havoc.c", 20, 0} true;
...
$bb6:
  ...
  assume {:sourceloc "sum01_havoc.c", 20, 0} true;
  assert $p7 == 1;
  assume {:sourceloc "sum01_havoc.c", 21, 0} true;
  $r := 0;
  return;
$bb7:
  assume {:sourceloc "sum01_havoc.c", 20, 0} true;
