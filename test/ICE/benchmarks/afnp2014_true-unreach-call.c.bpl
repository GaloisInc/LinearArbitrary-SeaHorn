...
axiom (__VERIFIER_nondet_int == -2048);
const unique __VERIFIER_assert: int;
axiom (__VERIFIER_assert == -3072);
  ...
  modifies alloc, $CurrAddr;
{
  ...
  var $b9: bool;
$bb0:
  assume {:sourceloc "afnp2014_true-unreach-call.c", 8, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "afnp2014_true-unreach-call.c", 9, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "afnp2014_true-unreach-call.c", 10, 0} true;
  $p := 0;
  $p1 := 1;
  goto $bb1;
$bb1:
...
$bb5:
  ...
  goto $bb3;
$bb6:
  assume {:sourceloc "afnp2014_true-unreach-call.c", 11, 0} true;
  $p6 := $add($p1, $p);
  assume {:sourceloc "afnp2014_true-unreach-call.c", 11, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "afnp2014_true-unreach-call.c", 12, 0} true;
  $p7 := $add($p, 1);
  assume {:sourceloc "afnp2014_true-unreach-call.c", 12, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "afnp2014_true-unreach-call.c", 13, 0} true;
  $p := $p7;
  $p1 := $p6;
  goto $bb1;
$bb7:
  assume {:sourceloc "afnp2014_true-unreach-call.c", 14, 0} true;
  $b3 := $sge($p1, $p);
  assume {:sourceloc "afnp2014_true-unreach-call.c", 14, 0} true;
  $p4 := $b2p($b3);
  assume {:sourceloc "afnp2014_true-unreach-call.c", 14, 0} true;
  assert $p4 == 1;
  assume {:sourceloc "afnp2014_true-unreach-call.c", 15, 0} true;
  return;
$bb8:
  assume $b2;
  goto $bb6;
