// SMACK-PRELUDE-BEGIN
function {:existential true} b0(m:int, aval:int, j:int, rows: int, cols: int, v1: int, v2: int, v3: int): bool;
  ...
  modifies $M.0, alloc, $CurrAddr;
{
  var $b: bool;
$bb0:
  assume {:sourceloc "matrix_inv1_havoc.c", 1, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 2, 0} true;
  $b := (cond != 0);
  assume {:sourceloc "matrix_inv1_havoc.c", 2, 0} true;
  goto $bb3, $bb4;
$bb1:
  assume {:sourceloc "matrix_inv1_havoc.c", 5, 0} true;
  return;
$bb2:
  assume {:sourceloc "matrix_inv1_havoc.c", 2, 0} true;
  goto $bb5;
...
$bb4:
  ...
  goto $bb2;
$bb5:
  assume {:sourceloc "matrix_inv1_havoc.c", 3, 0} true;
  goto $bb5;
}
  ...
  modifies $M.0, alloc, $CurrAddr;
{
  ...
  var $p35: int;
$bb0:
  assume {:sourceloc "matrix_inv1_havoc.c", 11, 0} true;
  havoc $p;
  assume $p > 0;
  assume {:sourceloc "matrix_inv1_havoc.c", 11, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 12, 0} true;
  havoc $p1;
  assume $p1 > 0;
  assume {:sourceloc "matrix_inv1_havoc.c", 12, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 17, 0} true;
  ...
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 19, 0} true;
  havoc $p5;
  assume {:sourceloc "matrix_inv1_havoc.c", 19, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 20, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 20, 0} true;
  $p6 := 0;
  ...
  goto $bb1;
$bb1:
  assert b0($p7,$M.0[$p4],$p6, $p1, $p, $p17, $p18, $p19);
  ...
  goto $bb4, $bb5;
$bb2:
  assume {:sourceloc "matrix_inv1_havoc.c", 23, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 23, 0} true;
  $p14 := 0;
  ...
  goto $bb6;
$bb3:
  assume {:sourceloc "matrix_inv1_havoc.c", 36, 0} true;
  $p8 := $mul(0, $p);
  assume {:sourceloc "matrix_inv1_havoc.c", 36, 0} true;
  $p9 := $pa($p4, $p8, 4);
  assume {:sourceloc "matrix_inv1_havoc.c", 36, 0} true;
  ...
  assume {:sourceloc "matrix_inv1_havoc.c", 36, 0} true;
  assert $p13 == 1;
  assume {:sourceloc "matrix_inv1_havoc.c", 37, 0} true;
...
$bb6:
  ...
  goto $bb9, $bb10;
$bb7:
  assume {:sourceloc "matrix_inv1_havoc.c", 26, 0} true;
  havoc $p21;
  assume {:sourceloc "matrix_inv1_havoc.c", 26, 0} true;
  $p22 := $mul($p6, $p);
  assume {:sourceloc "matrix_inv1_havoc.c", 26, 0} true;
  ...
  assume {:sourceloc "matrix_inv1_havoc.c", 26, 0} true;
  $M.0[$p24] := $p21;
  assume {:sourceloc "matrix_inv1_havoc.c", 28, 0} true;
  $p25 := $mul($p6, $p);
  assume {:sourceloc "matrix_inv1_havoc.c", 28, 0} true;
  $p26 := $pa($p4, $p25, 4);
  assume {:sourceloc "matrix_inv1_havoc.c", 28, 0} true;
  ...
  goto $bb14, $bb15;
$bb8:
  assume {:sourceloc "matrix_inv1_havoc.c", 31, 0} true;
  havoc $p17;
  assume {:sourceloc "matrix_inv1_havoc.c", 31, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 32, 0} true;
  havoc $p18;
  assume {:sourceloc "matrix_inv1_havoc.c", 32, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 33, 0} true;
  havoc $p19;
  assume {:sourceloc "matrix_inv1_havoc.c", 33, 0} true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  assume {:sourceloc "matrix_inv1_havoc.c", 34, 0} true;
  goto $bb11;
$bb9:
  assume {:sourceloc "matrix_inv1_havoc.c", 23, 0} true;
  assume $b16;
...
$bb11:
  ...
  goto $bb1;
$bb12:
  assume {:sourceloc "matrix_inv1_havoc.c", 29, 0} true;
  $p32 := $mul($p6, $p);
  assume {:sourceloc "matrix_inv1_havoc.c", 29, 0} true;
  $p33 := $pa($p4, $p32, 4);
  assume {:sourceloc "matrix_inv1_havoc.c", 29, 0} true;
  ...
  goto $bb13;
$bb13:
  assume {:sourceloc "matrix_inv1_havoc.c", 30, 0} true;
  goto $bb16;
$bb14:
  assume {:sourceloc "matrix_inv1_havoc.c", 28, 0} true;
  assume $b29;
